      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <a href="#" className="flex items-center mr-6">
            <img src="/logo.svg" alt="NiftyTrader Logo" className="h-8 mr-2" /> {/* Assuming logo.svg exists in public folder */}
      ...
      <div className="bg-gray-50 border-t border-gray-200">
        <div className="container mx-auto px-4 py-2 flex items-center justify-between text-sm">
          <div className="flex space-x-6">
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/option-chain.svg" alt="Option Chain" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              Option Chain
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/oi-charts.svg" alt="OI Charts" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              OI Charts
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/gft-nifty.svg" alt="GFT Nifty" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              GIFT Nifty
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/live-analytics.svg" alt="Live Analytics" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              Live Analytics
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/trending-oi.svg" alt="Trending OI" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              Trending OI
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/oi-timeline.svg" alt="OI Timeline" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              OI Timeline
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/futures.svg" alt="Futures" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              Futures
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/tv-chart.svg" alt="TV Chart" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              TV Chart
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/option-simulator.svg" alt="Option Simulator" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              Option Simulator
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 flex items-center">
              <img src="/icons/movers.svg" alt="Movers" className="h-5 w-5 mr-1" /> {/* Placeholder icon */}
              Movers
            </a>
          </div>
