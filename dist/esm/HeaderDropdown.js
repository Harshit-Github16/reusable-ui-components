...
import { socialLinks } from './FooterData.js';
import { analyticsData, backTestingData, optionsData, resourcesData, barsMenuData, profileData } from './HeaderData.js';
import apple_store_logo from './public/images/apple_store_logo.svg.js';
import giftNiftyIcon from './public/images/gift_nifty.svg.js';
import giftNiftyDarkIcon from './public/images/gift_nifty_dark.svg.js';
import menu_qr_codeImage from './public/images/menu-qr-code.svg.js';
import play_store_logo from './public/images/play_store_logo.svg.js';
import strategyIcon from './public/images/Header/strategy_builder.svg.js';
import silverIcon from './public/images/Header/silver.svg.js';
import goldIcon from './public/images/Header/gold.svg.js';
...
var HeaderDropDown = function (_a) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, analyticsData && /*#__PURE__*/React.createElement("div", {
    ref: function (el) {
  ...
  }, analyticsData.map(function (section, index) {
  ...
  }))))), backTestingData && /*#__PURE__*/React.createElement("div", {
    ref: function (el) {
    ...
    className: " tw-gap-4 tw-flex tw-justify-between  tw-w-full "
  }, backTestingData.map(function (section, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: index
    }, /*#__PURE__*/React.createElement("div", {
      className: "tw-flex tw-items-center tw-pb-2 tw-text-base tw-font-semibold tw-text-[#00498E] dark:!tw-text-[#409FFE] tw-border-b"
  ...
  }))))), optionsData && /*#__PURE__*/React.createElement("div", {
    ref: function (el) {
    ...
    className: " tw-gap-4 tw-flex tw-justify-between  tw-w-full "
  }, optionsData.map(function (section, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: index
    }, /*#__PURE__*/React.createElement("div", {
      className: "tw-flex tw-items-center tw-pb-2 tw-text-base tw-font-semibold tw-text-[#00498E] dark:!tw-text-[#409FFE] tw-border-b"
  ...
  }))))), resourcesData && /*#__PURE__*/React.createElement("div", {
    ref: function (el) {
    ...
    className: " tw-gap-4 tw-flex tw-justify-between  tw-w-full "
  }, resourcesData.map(function (section, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: index
    }, /*#__PURE__*/React.createElement("div", {
      className: "tw-flex tw-items-center tw-pb-2 tw-text-base tw-font-semibold tw-text-[#00498E] dark:!tw-text-[#409FFE] tw-border-b"
  ...
  }))))), barsMenuData && /*#__PURE__*/React.createElement("div", {
    ref: function (el) {
  ...
  }, barsMenuData.slice(0, 7).map(function (item, index) {
    ...
    className: "tw-after:h-full tw-after:block tw-after:w-[0.6px] tw-after:bg-[#dddddd] tw-after:absolute tw-after:right-0 tw-after:top-0 tw-px-6 tw-flex tw-justify-center tw-flex-col tw-relative tw-mb-2"
  }, barsMenuData.slice(7).map(function (item, index) {
    return /*#__PURE__*/React.createElement(Link, {
      key: index,
      href: generateHref(item === null || item === void 0 ? void 0 : item.pageUrl),
      onClick: function (e) {
  ...
  }, "For Android & IOS")))), profileData && /*#__PURE__*/React.createElement("div", {
    ref: function (el) {
  ...
  }, /*#__PURE__*/React.createElement("ul", null, (profileData === null || profileData === void 0 ? void 0 : profileData.length) > 0 && profileData.map(function (item, key) {
    return /*#__PURE__*/React.createElement("li", {
      key: key
    ...
    }, socialLinks.slice(0, 4).map(function (icon, index) {
      return /*#__PURE__*/React.createElement("li", {
        key: index,
