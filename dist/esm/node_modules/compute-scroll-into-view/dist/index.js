const t = t => "object" == typeof t && null != t && 1 === t.nodeType,
  ...
  r = (e, r) => {
    ...
    for (let t = 0; t < w.length; t++) {
      ...
      if (x >= 0 && R >= 0 && I <= H && C <= b && (e === m && !n(e) || x >= i && I <= d && R >= h && C <= s)) return L;
      ...
      if (m === e) B = o(M, M + H, H, p, T, M + k, M + k + v, v) , F = "start" === u ? D : "center" === u ? D - b / 2 : "end" === u ? D - b : o(y, y + b, b, g, W, y + D, y + D + E, E), B = Math.max(0, B + M), F = Math.max(0, F + y);else {
        B = o(i, d, l, p, T + S, k, k + v, v) , F = "start" === u ? D - h - g : "center" === u ? D - (h + r / 2) + V / 2 : "end" === u ? D - s + W + V : o(h, s, r, g, W + V, D, D + E, E);
        const {
          scrollLeft: t,
          scrollTop: n
        } = e;
