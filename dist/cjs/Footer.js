...
const Footer = props => {
  const {
    helpfulLinks: propHelpfulLinks = footerData.helpfulLinks,
    otherLinks: propOtherLinks = footerData.otherLinks,
    popularLinks: propPopularLinks = footerData.popularLinks,
    socialLinks: propSocialLinks = footerData.socialLinks,
    appStoreLinks,
    newsletter,
    copyright,
    className = ''
