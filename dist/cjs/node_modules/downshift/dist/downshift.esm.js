...
var Downshift = /*#__PURE__*/function () {
  var Downshift = /*#__PURE__*/function (_Component) {
    function Downshift(_props) {
      ...
      _this.getRootProps = function (_temp, _temp2) {
        ...
        var _ref = _temp === void 0 ? {} : _temp,
          ...
          ref = _ref.ref,
          rest = objectWithoutPropertiesLoose(_ref, _excluded$3);
      ...
      _this.getToggleButtonProps = function (_temp3) {
        ...
        var onKeyDown = _ref3.onKeyDown,
          ...
          onBlur = _ref3.onBlur,
          rest = objectWithoutPropertiesLoose(_ref3, _excluded2$3);
      ...
      _this.getInputProps = function (_temp4) {
        ...
        _ref4.onChangeText;
        var rest = objectWithoutPropertiesLoose(_ref4, _excluded3$2);
        var onChangeKey;
        var eventHandlers = {};
      ...
      _this.getMenuProps = function (_temp5, _temp6) {
        ...
        var _ref5 = _temp5 === void 0 ? {} : _temp5,
          ...
          ref = _ref5.ref,
          props = objectWithoutPropertiesLoose(_ref5, _excluded4$2);
      ...
      _this.getItemProps = function (_temp7) {
        ...
        var index = _ref7.index,
          ...
          rest = objectWithoutPropertiesLoose(_ref7, _excluded5);
        if (index === undefined) {
    ...
    inheritsLoose(Downshift, _Component);
...
process.env.NODE_ENV !== "production" ? Downshift.propTypes = {
  children: index$1.func,
  defaultHighlightedIndex: index$1.number,
  defaultIsOpen: index$1.bool,
  initialHighlightedIndex: index$1.number,
  initialSelectedItem: index$1.any,
  initialInputValue: index$1.string,
  initialIsOpen: index$1.bool,
  getA11yStatusMessage: index$1.func,
  itemToString: index$1.func,
  onChange: index$1.func,
  onSelect: index$1.func,
  onStateChange: index$1.func,
  onInputValueChange: index$1.func,
  onUserAction: index$1.func,
  onOuterClick: index$1.func,
  selectedItemChanged: index$1.func,
  stateReducer: index$1.func,
  itemCount: index$1.number,
  id: index$1.string,
  environment: index$1.shape({
    addEventListener: index$1.func.isRequired,
    removeEventListener: index$1.func.isRequired,
    document: index$1.shape({
      createElement: index$1.func.isRequired,
      getElementById: index$1.func.isRequired,
      activeElement: index$1.any.isRequired,
      body: index$1.any.isRequired
    }).isRequired,
    Node: index$1.func.isRequired
  }),
  suppressRefError: index$1.bool,
  scrollIntoView: index$1.func,
  // things we keep in state for uncontrolled components
  // but can accept as props for controlled components
  /* eslint-disable react/no-unused-prop-types */
  selectedItem: index$1.any,
  isOpen: index$1.bool,
  inputValue: index$1.string,
  highlightedIndex: index$1.number,
  labelId: index$1.string,
  inputId: index$1.string,
  menuId: index$1.string,
  getItemId: index$1.func
...
var commonDropdownPropTypes = _extends({}, commonPropTypes, {
  ...
  selectedItem: index$1.any,
  initialSelectedItem: index$1.any,
  defaultSelectedItem: index$1.any,
  id: index$1.string,
  labelId: index$1.string,
  menuId: index$1.string,
  getItemId: index$1.func,
  toggleButtonId: index$1.string,
  onSelectedItemChange: index$1.func,
  onHighlightedIndexChange: index$1.func,
  onStateChange: index$1.func,
  onIsOpenChange: index$1.func,
  scrollIntoView: index$1.func
});
...
_tslib.__assign(_tslib.__assign({}, commonDropdownPropTypes), {
  items: index$1.array.isRequired,
  isItemDisabled: index$1.func
});
...
var propTypes$1 = _extends({}, commonDropdownPropTypes, {
  ...
  isItemDisabled: index$1.func,
  inputValue: index$1.string,
  defaultInputValue: index$1.string,
  initialInputValue: index$1.string,
  inputId: index$1.string,
  onInputValueChange: index$1.func
});
...
if (process.env.NODE_ENV !== 'production') {
  validatePropTypes$1 = function validatePropTypes(options, caller) {
    index$1.checkPropTypes(propTypes$1, options, 'prop', caller.name);
  };
}
...
function useCombobox(userProps) {
  ...
  var getMenuProps = React.useCallback(function (_temp, _temp2) {
    ...
    var _ref = _temp === void 0 ? {} : _temp,
      ...
      refKey = _ref$refKey === void 0 ? 'ref' : _ref$refKey,
      ref = _ref.ref,
      rest = objectWithoutPropertiesLoose(_ref, _excluded$1);
    var _ref2 = _temp2 === void 0 ? {} : _temp2,
      _ref2$suppressRefErro = _ref2.suppressRefError,
      suppressRefError = _ref2$suppressRefErro === void 0 ? false : _ref2$suppressRefErro;
  ...
  var getItemProps = React.useCallback(function (_temp3) {
    ...
    var disabledProp = _ref3.disabled,
      rest = objectWithoutPropertiesLoose(_ref3, _excluded2$1);
  ...
  var getToggleButtonProps = React.useCallback(function (_temp4) {
    ...
    var _ref5$refKey = _ref5.refKey,
      refKey = _ref5$refKey === void 0 ? 'ref' : _ref5$refKey,
      ref = _ref5.ref,
      rest = objectWithoutPropertiesLoose(_ref5, _excluded3);
    var latestState = latest.current.state;
  ...
  var getInputProps = React.useCallback(function (_temp5, _temp6) {
    ...
    var onClick = _ref6.onClick,
      ...
      ref = _ref6.ref,
      rest = objectWithoutPropertiesLoose(_ref6, _excluded4);
...
({
  ...
  selectedItems: index$1.array,
  initialSelectedItems: index$1.array,
  defaultSelectedItems: index$1.array,
  getA11yStatusMessage: index$1.func,
  activeIndex: index$1.number,
  initialActiveIndex: index$1.number,
  defaultActiveIndex: index$1.number,
  onActiveIndexChange: index$1.func,
  onSelectedItemsChange: index$1.func,
  keyNavigationNext: index$1.string,
  keyNavigationPrevious: index$1.string
});
({
