...
var index$2 = require('../node_modules/react-is/index.js');
var index = require('../../compute-scroll-into-view/dist/index.js');
...
function scrollIntoView(node, menuNode) {
  ...
  var actions = index.compute(node, {
    boundary: menuNode});
  ...
  var Downshift = /*#__PURE__*/function (_Component) {
    function Downshift(_props) {
      ...
      _this.setHighlightedIndex = function (highlightedIndex, otherStateToSet) {
        ...
        _this.internalSetState(_extends.default({
      ...
      _this.internalSetState = function (stateToSet, cb) {
        ...
        if (!isStateToSetFunction && stateToSet.hasOwnProperty('inputValue')) {
          _this.props.onInputValueChange(stateToSet.inputValue, _extends.default({}, _this.getStateAndHelpers(), stateToSet));
        }
        return _this.setState(function (state) {
          ...
          if (isStateToSetFunction && newStateToSet.hasOwnProperty('inputValue')) {
            _this.props.onInputValueChange(newStateToSet.inputValue, _extends.default({}, _this.getStateAndHelpers(), newStateToSet));
          }
          return nextState;
        }, function () {
      ...
      _this.getRootProps = function (_temp, _temp2) {
        ...
        var _ref = _temp === void 0 ? {} : _temp,
          ...
          ref = _ref.ref,
          rest = objectWithoutPropertiesLoose.default(_ref, _excluded$3);
        ...
        return _extends.default((_extends2 = {}, _extends2[refKey] = handleRefs(ref, _this.rootRef), _extends2.role = 'combobox', _extends2['aria-expanded'] = isOpen, _extends2['aria-haspopup'] = 'listbox', _extends2['aria-owns'] = isOpen ? _this.menuId : undefined, _extends2['aria-labelledby'] = _this.labelId, _extends2), rest);
      };
      //\\\\\\\\\\\\\\\\\\\\\\\\\\ ROOT
      ...
      //////////////////////////// BUTTON
      _this.buttonKeyDownHandlers = _extends.default({}, _this.keyDownHandlers, {
        ' ': function _(event) {
          event.preventDefault();
          this.toggleMenu({
      ...
      _this.inputKeyDownHandlers = _extends.default({}, _this.keyDownHandlers, {
      ...
      _this.getToggleButtonProps = function (_temp3) {
        ...
        var onKeyDown = _ref3.onKeyDown,
          ...
          onBlur = _ref3.onBlur,
          rest = objectWithoutPropertiesLoose.default(_ref3, _excluded2$3);
      ...
      _this.getInputProps = function (_temp4) {
        ...
        _ref4.onChangeText;
        var rest = objectWithoutPropertiesLoose.default(_ref4, _excluded3$2);
        var onChangeKey;
        var eventHandlers = {};
      ...
      _this.getMenuProps = function (_temp5, _temp6) {
        ...
        var _ref5 = _temp5 === void 0 ? {} : _temp5,
          ...
          ref = _ref5.ref,
          props = objectWithoutPropertiesLoose.default(_ref5, _excluded4$2);
        ...
        return _extends.default((_extends3 = {}, _extends3[refKey] = handleRefs(ref, _this.menuRef), _extends3.role = 'listbox', _extends3['aria-labelledby'] = props && props['aria-label'] ? undefined : _this.labelId, _extends3.id = _this.menuId, _extends3), props);
      };
      //\\\\\\\\\\\\\\\\\\\\\\\\\\\\\ MENU
      /////////////////////////////// ITEM
      _this.getItemProps = function (_temp7) {
        ...
        var index = _ref7.index,
          ...
          rest = objectWithoutPropertiesLoose.default(_ref7, _excluded5);
        if (index === undefined) {
      ...
      _this.updateStatus = debounce(function () {
        ...
        var status = _this.props.getA11yStatusMessage(_extends.default({
    ...
    inheritsLoose.default(Downshift, _Component);
...
process.env.NODE_ENV !== "production" ? Downshift.propTypes = {
  children: index$1.default.func,
  defaultHighlightedIndex: index$1.default.number,
  defaultIsOpen: index$1.default.bool,
  initialHighlightedIndex: index$1.default.number,
  initialSelectedItem: index$1.default.any,
  initialInputValue: index$1.default.string,
  initialIsOpen: index$1.default.bool,
  getA11yStatusMessage: index$1.default.func,
  itemToString: index$1.default.func,
  onChange: index$1.default.func,
  onSelect: index$1.default.func,
  onStateChange: index$1.default.func,
  onInputValueChange: index$1.default.func,
  onUserAction: index$1.default.func,
  onOuterClick: index$1.default.func,
  selectedItemChanged: index$1.default.func,
  stateReducer: index$1.default.func,
  itemCount: index$1.default.number,
  id: index$1.default.string,
  environment: index$1.default.shape({
    addEventListener: index$1.default.func.isRequired,
    removeEventListener: index$1.default.func.isRequired,
    document: index$1.default.shape({
      createElement: index$1.default.func.isRequired,
      getElementById: index$1.default.func.isRequired,
      activeElement: index$1.default.any.isRequired,
      body: index$1.default.any.isRequired
    }).isRequired,
    Node: index$1.default.func.isRequired
  }),
  suppressRefError: index$1.default.bool,
  scrollIntoView: index$1.default.func,
  // things we keep in state for uncontrolled components
  // but can accept as props for controlled components
  /* eslint-disable react/no-unused-prop-types */
  selectedItem: index$1.default.any,
  isOpen: index$1.default.bool,
  inputValue: index$1.default.string,
  highlightedIndex: index$1.default.number,
  labelId: index$1.default.string,
  inputId: index$1.default.string,
  menuId: index$1.default.string,
  getItemId: index$1.default.func
...
function validateGetRootPropsCalledCorrectly(element, _ref13) {
  ...
  if (isComposite && !refKeySpecified && !index$2.reactIsExports.isForwardRef(element)) {
    // eslint-disable-next-line no-console
  ...
  if (!index$2.reactIsExports.isForwardRef(element) && !getElementProps(element)[refKey]) {
    // eslint-disable-next-line no-console
...
function callOnChangeProps(action, state, newState) {
  ...
  if (props.onStateChange && Object.keys(changes).length) {
    props.onStateChange(_extends.default({
      type: type
    }, changes));
  }
}
function invokeOnChangeHandler(key, action, state, newState) {
  ...
  if (props[handler] && newState[key] !== undefined && newState[key] !== state[key]) {
    props[handler](_extends.default({
      type: type
    }, newState));
  }
}
...
function useEnhancedReducer(reducer, props, createInitialState, isStateEqual) {
  ...
  var enhancedReducer = React.useCallback(function (state, action) {
    ...
    var newState = action.props.stateReducer(state, _extends.default({}, action, {
      changes: changes
    }));
    return newState;
  }, [reducer]);
  ...
  var dispatchWithProps = React.useCallback(function (action) {
    return dispatch(_extends.default({
...
var commonPropTypes = {
  ...
  itemToString: index$1.default.func,
  itemToKey: index$1.default.func,
  stateReducer: index$1.default.func
};

// Shared between useSelect, useCombobox, Downshift.
var commonDropdownPropTypes = _extends.default({}, commonPropTypes, {
  getA11yStatusMessage: index$1.default.func,
  highlightedIndex: index$1.default.number,
  defaultHighlightedIndex: index$1.default.number,
  initialHighlightedIndex: index$1.default.number,
  ...
  selectedItem: index$1.default.any,
  initialSelectedItem: index$1.default.any,
  defaultSelectedItem: index$1.default.any,
  id: index$1.default.string,
  labelId: index$1.default.string,
  menuId: index$1.default.string,
  getItemId: index$1.default.func,
  toggleButtonId: index$1.default.string,
  onSelectedItemChange: index$1.default.func,
  onHighlightedIndexChange: index$1.default.func,
  onStateChange: index$1.default.func,
  onIsOpenChange: index$1.default.func,
  scrollIntoView: index$1.default.func
});
function downshiftCommonReducer(state, action, stateChangeTypes) {
  ...
  return _extends.default({}, state, changes);
}
_tslib.__assign(_tslib.__assign({}, commonDropdownPropTypes), {
  items: index$1.default.array.isRequired,
  isItemDisabled: index$1.default.func
});
_tslib.__assign(_tslib.__assign({}, defaultProps$3), {
...
function getInitialState$1(props) {
  ...
  return _extends.default({}, initialState, {
    inputValue: inputValue
  });
}
var propTypes$1 = _extends.default({}, commonDropdownPropTypes, {
  items: index$1.default.array.isRequired,
  isItemDisabled: index$1.default.func,
  inputValue: index$1.default.string,
  defaultInputValue: index$1.default.string,
  initialInputValue: index$1.default.string,
  inputId: index$1.default.string,
  onInputValueChange: index$1.default.func
});
...
if (process.env.NODE_ENV !== 'production') {
  validatePropTypes$1 = function validatePropTypes(options, caller) {
    index$1.default.checkPropTypes(propTypes$1, options, 'prop', caller.name);
  };
}
var defaultProps$1 = _extends.default({}, defaultProps$3, {
...
function useCombobox(userProps) {
  ...
  var props = _extends.default({}, defaultProps$1, userProps);
  var items = props.items,
  ...
  var getMenuProps = React.useCallback(function (_temp, _temp2) {
    ...
    var _ref = _temp === void 0 ? {} : _temp,
      ...
      refKey = _ref$refKey === void 0 ? 'ref' : _ref$refKey,
      ref = _ref.ref,
      rest = objectWithoutPropertiesLoose.default(_ref, _excluded$1);
    var _ref2 = _temp2 === void 0 ? {} : _temp2,
      _ref2$suppressRefErro = _ref2.suppressRefError,
      suppressRefError = _ref2$suppressRefErro === void 0 ? false : _ref2$suppressRefErro;
    setGetterPropCallInfo('getMenuProps', suppressRefError, refKey, menuRef);
    return _extends.default((_extends2 = {}, _extends2[refKey] = handleRefs(ref, function (menuNode) {
  ...
  var getItemProps = React.useCallback(function (_temp3) {
    ...
    var disabledProp = _ref3.disabled,
      rest = objectWithoutPropertiesLoose.default(_ref3, _excluded2$1);
    ...
    return _extends.default((_extends3 = {}, _extends3[refKey] = handleRefs(ref, function (itemNode) {
      if (itemNode) {
  ...
  var getToggleButtonProps = React.useCallback(function (_temp4) {
    ...
    var _ref5$refKey = _ref5.refKey,
      refKey = _ref5$refKey === void 0 ? 'ref' : _ref5$refKey,
      ref = _ref5.ref,
      rest = objectWithoutPropertiesLoose.default(_ref5, _excluded3);
    var latestState = latest.current.state;
    ...
    return _extends.default((_extends4 = {}, _extends4[refKey] = handleRefs(ref, function (toggleButtonNode) {
      toggleButtonRef.current = toggleButtonNode;
    }), _extends4['aria-controls'] = elementIds.menuId, _extends4['aria-expanded'] = latestState.isOpen, _extends4.id = elementIds.toggleButtonId, _extends4.tabIndex = -1, _extends4), !rest.disabled && _extends.default({}, {
  ...
  var getInputProps = React.useCallback(function (_temp5, _temp6) {
    ...
    var onClick = _ref6.onClick,
      ...
      ref = _ref6.ref,
      rest = objectWithoutPropertiesLoose.default(_ref6, _excluded4);
    ...
    return _extends.default((_extends5 = {}, _extends5[refKey] = handleRefs(ref, function (inputNode) {
...
({
  ...
  selectedItems: index$1.default.array,
  initialSelectedItems: index$1.default.array,
  defaultSelectedItems: index$1.default.array,
  getA11yStatusMessage: index$1.default.func,
  activeIndex: index$1.default.number,
  initialActiveIndex: index$1.default.number,
  defaultActiveIndex: index$1.default.number,
  onActiveIndexChange: index$1.default.func,
  onSelectedItemsChange: index$1.default.func,
  keyNavigationNext: index$1.default.string,
  keyNavigationPrevious: index$1.default.string
});
({
...
//# sourceMappingURL=downshift.esm.js.map
